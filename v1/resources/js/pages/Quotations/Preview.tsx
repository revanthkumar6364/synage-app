                    ...
                    <div className="max-w-[900px] mx-auto border border-gray-700 text-[10px] leading-[1.1] select-none">
                        ...
                        <div className="flex border-b border-gray-400">
                            <div className="w-[180px] p-2">
                                <div className="flex flex-col items-start">
                                    <div className="text-[14px] font-extralight leading-[1] text-[#0f2f5a] flex flex-wrap">
                                        R A<span className="font-semibold">D</span>I A N T
                                    </div>
                                    <div className="text-[14px] font-extralight leading-[1] text-[#5ea9e6] ml-6 -mt-1">S Y N A G E</div>
                                </div>
                            ...
                            <tbody>
                                <tr className="bg-[#2f6cc1] text-white text-[10px] font-semibold text-center">
                                    <td className="py-3" colSpan={11}>
                                        ...
                                        <br />
                                        <br />
                                        Available Size : {quotation.available_size} mm W x 3330 mm H
                                        <br />
                                        <br />
                                        Proposed Size : {quotation.proposed_size} mm W x 3200 mm H | 4.2 ft W x 10.5 Ft H = 45 Sq ft | 4 R x 20 C of 320 W x 160 H mm
                                        Modules
                                        <br />
                                        Resolution: 512 x {Number(quotation.proposed_size)} = {Number(quotation.proposed_size) * 512} Pixels
                                    </td>
                                </tr>
                        ...
                        <div className="mt-3 px-2">
                            <div className="flex items-center space-x-2 select-none">
                                <div className="text-[#0f2f5a] font-extralight text-[14px] leading-[1] flex flex-wrap">
                                    R A<span className="font-semibold">D</span>I A N T
                                </div>
                                <div className="text-[#5ea9e6] font-extralight text-[14px] leading-[1] ml-1 -mt-1">S Y N A G E</div>
                            </div>
                        </div>
                        ...
                        <div className="border border-gray-400 mt-2">
                            <div className="flex justify-between items-center border-b border-gray-400 px-2 py-1">
                                ...
                                <div className="text-[#0f2f5a] font-extralight text-[14px] leading-[1] flex flex-wrap select-none">
                                    R A<span className="font-semibold">D</span>I A N T
                                    <span className="text-[#5ea9e6] font-extralight ml-1 -mt-1">S Y N A G E</span>
                                </div>
                            </div>
                            <div className="px-2 py-2 text-[9px] leading-[1.3] space-y-2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td className="border border-gray-700 text-left px-2 py-1 font-normal italic">
                                                <b>TAXES</b>
                                                <br />
                                                The above price is inclusive of all taxes and duties
                                                <br />
                                                <b>Warranty</b>
                                                <br />
                                                The Entire solutions has 3 years Warranty | No Warranty for Phyiscal Damages or Burnouts
                                                <br />
                                                <b>Delivery Terms</b>
                                                <br />
                                                Delivery timeline is 2 - 3 weeks, from the receipt of Advance Payment
                                                <br />
                                                <b>Payment Terms</b>
                                                <br />
                                                50% Advance along with the Purchase & 50% against Delivery and Installation
                                                <br />
                                                <b>Electrical Points and Installation</b>
                                                <br />
                                                Power Sockets need to be provided by Client | Network - Client Scope
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <div className="flex items-center space-x-1 select-none">
                                    <div className="text-[#0f2f5a] font-extralight text-[10px] leading-[1] flex flex-wrap">
                                        R A<span className="font-semibold">D</span>I A N T
                                    </div>
                                    <div className="text-[#5ea9e6] font-extralight text-[10px] leading-[1] ml-1 -mt-1">S Y N A G E</div>
                                </div>
                            </div>
                        </div>
                    </div>
